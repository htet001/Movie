...
@section('title','Admin Premium Movie Create')
@section('content')
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="form-container">
                ...
                @endif
                <h2 class="text-center mb-5">Create Premium Movie</h2>
                <form method="post" action="{{route('premiumMovie.create')}}" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
